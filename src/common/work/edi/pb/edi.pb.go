...
func init() {
	proto.RegisterType((*EDIRequest)(nil), "EDIRequest")
	proto.RegisterType((*EDIResponse)(nil), "EDIResponse")
}
...
var fileDescriptor_184d4dc8ed712ec4 = []byte{
	...
	,
}
...
func (c *eDICallClient) Call(ctx context.Context, in *EDIRequest, opts ...grpc.CallOption) (*EDIResponse, error) {
	out := new(EDIResponse)
	err := c.cc.Invoke(ctx, "/EDICall/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eDICallClient) ServerStreamingCall(ctx context.Context, in *EDIRequest, opts ...grpc.CallOption) (EDICall_ServerStreamingCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &_EDICall_serviceDesc.Streams[0], "/EDICall/ServerStreamingCall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *eDICallClient) ClientStreamingCall(ctx context.Context, opts ...grpc.CallOption) (EDICall_ClientStreamingCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &_EDICall_serviceDesc.Streams[1], "/EDICall/ClientStreamingCall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *eDICallClient) BidirectionalStreamingCall(ctx context.Context, opts ...grpc.CallOption) (EDICall_BidirectionalStreamingCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &_EDICall_serviceDesc.Streams[2], "/EDICall/BidirectionalStreamingCall", opts...)
	if err != nil {
		return nil, err
	}
